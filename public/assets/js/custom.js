    ...
    if (document.getElementById("days1")) {
        ...
        x = setInterval(function () {
            if (document.querySelectorAll(".contdown_row").length == 1) {
                ...
                for (
                    i = 1;
                    i <= document.querySelectorAll(".contdown_row").length;
                    i++
                ) {
                    console.log($("[data-timer=" + i + "]").attr("data-date"));
                    var date_date = $("[data-timer=" + i + "]").attr(
                        "data-date"
                    );
                    ...
                    (document.getElementById("days" + [i]).innerText =
                        ...
                        (document.getElementById("hours" + [i]).innerText =
                            Math.floor((distance % day) / hour)),
                        (document.getElementById("minutes" + [i]).innerText =
                            Math.floor((distance % hour) / minute)),
                        (document.getElementById("seconds" + [i]).innerText =
