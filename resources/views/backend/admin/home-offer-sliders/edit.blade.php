    ...
    <section class="section">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-dark text-white-all">
                ...
                <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-list"></i>Update Home Offer Slider
                    Detail</li>
                <li class="breadcrumb-item"><a href="{{ route('admin.home-offer-sliders.all') }}"> All Home Offer Slider</a>
                </li>
            </ol>
        </nav>
        <div class="card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="sort_index" class="form-control" id="sort_index"
                                            value="{{ $homeOfferSlider->sort_index }}" placeholder="Enter Sort Index"
                                            min="0" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="status" class="form-control">
                                            ...
                                            <option value="1" {{ $homeOfferSlider->status == true ? 'selected' : '' }}>Activate
                                            </option>
                                            <option value="0" {{ $homeOfferSlider->status == false ? 'selected' : '' }}>
                                                Deactivate
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <small class="form-text text-muted">Please maintain image size of 1920x800 px and
                                            upload image below 5 KB.</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <img src="{!! asset('storage/images/home-offer-sliders') . '/' . $homeOfferSlider->image_url !!}"
                                    alt="Slider Title" class="img img-responsive img-thumbnail" width="350px">
                            </div>
                        </div>
