                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="url" id="url" class="form-control" placeholder="Enter Url (e.g. https://...)"
                                        value="{{ old('url') }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="text_align" id="text_align" class="form-control">
                                        ...
                                        <option value="center" {{ old('text_align') == 'center' ? 'selected' : '' }}>Center</option>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="sort_index" class="form-control" id="sort_index"
                                        value="{{ old('sort_index', 1) }}" placeholder="Enter Sort Index" min="0" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ $slider->desktop_image_url }}" target="_blank"
                                    title="Slider Image">
                                    <img src="{{ $slider->desktop_image_url }}"
                                        alt="Slider Image" width="60px" class="rounded border">
                                </a>
                                @else
