                    ...
                    <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="button_text" id="button_text" class="form-control"
                                            placeholder="e.g. Shop Now" value="{{ $slider->button_text }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="text_align" id="text_align" class="form-control">
                                            <option value="left" {{ $slider->text_align == 'left' ? 'selected' : '' }}>Left
                                            </option>
                                            <option value="center" {{ $slider->text_align == 'center' ? 'selected' : '' }}>
                                                Center</option>
                                            <option value="right" {{ $slider->text_align == 'right' ? 'selected' : '' }}>Right
                                            </option>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                @else
                                    <p class="text-muted"><small>No specific mobile image uploaded.<br>(Desktop image will be
                                            used as fallback)</small></p>
                                @endif
                            </div>
                        </div>
