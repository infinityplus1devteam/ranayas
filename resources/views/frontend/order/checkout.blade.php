                    ...
                    @if (auth('user')->check())
                        ...
                        <div class="col-md-12">
                            <form action="{{ route('order.checkout') }}" method="post" id="formCheckout">
                                @csrf
                                <input type="hidden" name="pincode" id="checkout_pincode">
                                <div class="row">
                                    <div class="col">
                                        <div class="checkout-area">
                                            <div class="billing-area">
                                                ...
                                                <div class="row address_div">
                                                    @if (count($addresses))
                                                        <div class="col-md-12 mb-3 checkout-form"
                                                            id="selected_address_delivery_status">
                                                            <div class="p-3 border rounded" style="background-color: #f8f9fa;">
                                                                <label for="pincode" class="error pincode_error m-0"
                                                                    style="font-weight: 500; font-size: 15px; color: rgb(238, 53, 53); display: none;"></label>
                                                                <p class="text-success pincode_success m-0"
                                                                    style="font-weight: 500; font-size: 15px; color: #28a745; display: none;">
                                                                </p>
                                                                <p class="text-success estimated_date m-0"
                                                                    style="font-size: 14px; color: #28a745; display: none;"></p>
                                                            </div>
                                                        </div>
                                                    @endif
                                                                ...
                                                                <div class="address-card card h-100">
                                                                    <div class="card-body">
                                                                        <div
                                                                            ...
                                                                            <span
                                                                                class="address-badge">{{ $add->type_of_address ? 'Work' : 'Home' }}</span>
                                                                        </div>
                                                                        <p class="address-text">
                                                                            {{ $add->address }},<br>
                                                                            @if ($add->landmark)<span
                                                                                class="text-muted small">Landmark:
                                                                            {{ $add->landmark }}</span><br>@endif
                                                                            {{ $add->city }}, {{ $add->territory }},
                                                                        ...
                                                                        @else
                                                                            <div class="address-phone text-danger">
                                                                                <i class="fa fa-exclamation-triangle"></i> Update Mobile
                                                                                Number
                                                                            </div>
                                                                        @endif
                                                                    </div>
                                                                    <div class="card-footer">
                                                                        <a href="javascript:void(0)"
                                                                            ...
                                                                            data-obj-id="{{ $add->id }}"><i class="fa fa-trash"></i>
                                                                            Remove</a>
                                                            ...
                                                            <div class="payment-group pymt-btn mb--10">
                                                                <div class="payment-radio">
                                                                    <label for="razorpay" class="cb-container">
                                                                        NETBANKING/CARD/UPI
                                                                        <input type="radio" value="razorpay" name="payment_mode"
                                                                            id="razorpay">
                                                                        <span class="rb-checkmark"></span>
                                                                    </label>
                                                                </div>
                        ...
                        @if (!count($addresses))
                            <div class="col-md-6">
                                <div class="new-delivery-address profile-form"
                                    style="background: #fff; padding: 25px; border-radius: 5px; border: 1px solid #e2e2e2; margin-bottom: 30px;">
                                    <div class="title-area mb-4">
                                        <h4 style="font-weight: 600; font-size: 18px; margin-bottom: 20px;">Add New Delivery Address
                                        </h4>
                                    </div>

                                    <div class="checkout-form row mb-3">
                                        <div class="col-12">
                                            <label style="padding: 10px 0px; display: block; font-weight: 500;">Please enter PIN
                                                code to check delivery <span class="required" style="color:red">*</span></label>
                                        ...
                                        <div class="col-12 pincd mt-2">
                                            <label for="pincode" class="error pincode_error m-0"
                                                style="font-weight: 500; font-size: 15px; color: rgb(238, 53, 53); display: none;"></label>
                                            <p class="text-success pincode_success m-0"
                                                style="font-weight: 500; font-size: 15px; color: #28a745; display: none;"></p>
                                            <p class="text-success estimated_date m-0"
                                                style="font-size: 14px; color: #28a745; display: none;"></p>
                                        </div>
                                    </div>
                                    ...
                                    <form action="{{ route('user.addresses.add') }}" method="post" id="formAddAddress" class="form">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <label style="padding: 10px 0px; display: block; font-weight: 500;">Email Address
                                                    <span class="required" style="color:red">*</span></label>
                                                <input type="email" name="email" id="email" placeholder="Email Address*"
                                                    value="{{ optional(auth('user')->user())->email ? auth('user')->user()->email : old('email') }}"
                                                    {{ optional(auth('user')->user())->email ? 'disabled' : '' }}
                                                    required
                                                    style="padding: 10px 15px !important; border: 1px solid #e2e2e2; width: 100%; border-radius: 4px; {{ optional(auth('user')->user())->email ? 'background:#f5f5f5; cursor:not-allowed;' : '' }}">
                                                @if(optional(auth('user')->user())->email)
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-12">
                                                <label style="padding: 10px 0px; display: block; font-weight: 500;">Town / City
                                                    <span class="required" style="color:red">*</span></label>
                                                <input type="text" name="city" id="city" required placeholder="Town/City*"
                                                    value="{{ old('city') }}"
                                                    style="padding: 10px 15px !important; border: 1px solid #e2e2e2; width: 100%; border-radius: 4px;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-12">
                                                <button type="submit" class="btn btn-style1 btnSubmit"
                                                    style="color: #fff !important; background-color: var(--theme-color) !important; border: 2px solid transparent !important; padding: 12px 30px; font-weight: 600; text-transform: uppercase; width: 100%; border-radius: 4px; transition: all 0.3s ease;">SAVE
                        ...
                        <div class="form profile-form">
                            ...
                            <div class="row mb-3">
                                <div class="col-12">
                                    <label style="padding: 10px 0px; display: block; font-weight: 500;">Name <span
                                            class="required" style="color:red">*</span></label>
                                    <input type="text" name="name" id="name" required placeholder="Name*" value=""
                                        style="padding: 10px 15px !important; border: 1px solid #e2e2e2; width: 100%; border-radius: 4px;">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <label style="padding: 10px 0px; display: block; font-weight: 500;">Pincode <span
                                            class="required" style="color:red">*</span></label>
                                    <input type="text" name="pincode" id="pincode_modal" placeholder="Pincode*" required
                                        style="padding: 10px 15px !important; border: 1px solid #e2e2e2; width: 100%; border-radius: 4px;">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-12">
                                    <label style="padding: 10px 0px; display: block; font-weight: 500;">House number and
                                        street name <span class="required" style="color:red">*</span></label>
                                    <input type="text" name="address" id="address" required placeholder="Address*" value=""
                                        style="padding: 10px 15px !important; border: 1px solid #e2e2e2; width: 100%; border-radius: 4px;">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6 mb-3 mb-md-0">
                                    <label style="padding: 10px 0px; display: block; font-weight: 500;">Town / City <span
                                            class="required" style="color:red">*</span></label>
                                    <input type="text" name="city" id="city" required placeholder="Town/City*" value=""
                                        style="padding: 10px 15px !important; border: 1px solid #e2e2e2; width: 100%; border-radius: 4px;">
                                </div>
                                <div class="col-md-6">
                                    <label style="padding: 10px 0px; display: block; font-weight: 500;">State <span
...
@section('extrajs')
    ...
    <script>
        var userEmail = '{{ optional(auth('user')->user())->email ?? '' }}';
                                    ...
                                    `<div class="form profile-form">
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <input type="email" name="email" id="edit_email" placeholder="Email Address*" value="${data.email ? data.email : userEmail}" ${userEmail ? 'disabled style="padding: 10px 15px !important; border: 1px solid #e2e2e2; width: 100%; border-radius: 4px; background:#f5f5f5; cursor:not-allowed;"' : 'style="padding: 10px 15px !important; border: 1px solid #e2e2e2; width: 100%; border-radius: 4px;"'} required>
                                                                        ${userEmail ? '<input type="hidden" name="email" value="' + (data.email ? data.email : userEmail) + '">' : ''}
                                                                    </div>
                                                                </div>
