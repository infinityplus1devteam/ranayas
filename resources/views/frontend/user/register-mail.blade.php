@extends('layouts.master') @section('title', 'Register with Mail') @section('content')
...
<div class="signUp-page signUp-minimal">
    <div class="signin-form-wrapper">
        ...
        <ul class="social-icon-wrapper row">
            <li class="col-12">
                <a href="{{ route('user.register') }}" class="otp"><i class="fa fa-mobile"
                        aria-hidden="true" style="position: relative; top: 2px; font-size: 20px; margin-right: 2px;"></i>
                    Register With Phone Number</a>
            </li>
